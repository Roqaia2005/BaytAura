...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function( List<ChatMessage> messages)?  loading,TResult Function( List<ChatMessage> messages)?  loaded,TResult Function( String message,  List<ChatMessage> messages)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case _Loading() when loading != null:
return loading(_that.messages);case _Loaded() when loaded != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function( List<ChatMessage> messages)  loading,required TResult Function( List<ChatMessage> messages)  loaded,required TResult Function( String message,  List<ChatMessage> messages)  error,}) {final _that = this;
switch (_that) {
case _Initial():
return initial();case _Loading():
return loading(_that.messages);case _Loaded():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function( List<ChatMessage> messages)?  loading,TResult? Function( List<ChatMessage> messages)?  loaded,TResult? Function( String message,  List<ChatMessage> messages)?  error,}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case _Loading() when loading != null:
return loading(_that.messages);case _Loaded() when loaded != null:
...
class _Loading implements ChatState {
  const _Loading(final  List<ChatMessage> messages): _messages = messages;
...
class _Loaded implements ChatState {
  const _Loaded(final  List<ChatMessage> messages): _messages = messages;
...
class _Error implements ChatState {
  const _Error(this.message, final  List<ChatMessage> messages): _messages = messages;
...
@useResult
$Res call({
 String message, List<ChatMessage> messages
});
...
/// Create a copy of ChatState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? message = null,Object? messages = null,}) {
  return _then(_Error(
null == message ? _self.message : message // ignore: cast_nullable_to_non_nullable
as String,null == messages ? _self._messages : messages // ignore: cast_nullable_to_non_nullable
as List<ChatMessage>,
  ));
}
